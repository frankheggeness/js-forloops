...
for(i = 0; i < presidents.length; i ++){
   console.log(presidents[i] + ' was a great leader.')
}
...
function arrayCopy(originArray, destinationArray){
...
/* 12) Puppet Master
Declare a vascStorage` set it's value to be: `[ [], 'Carrots', 9, 'Beets', {}, {name: "Todd B."}, 'Mush' ]`
